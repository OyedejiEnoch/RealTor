...
const ListingItem = ({ listing, id, onDelete, onEdit }) => {
  ...
  return (
    <li
      className="relative bg-white flex flex-col justify-between items-center shadow-md hover:shadow-xl rounded-md overflow-hidden
    ...
    >
      <Link to={`/category/${listing.type}/${id}`}>
        ...
        />
        <Moment
          className="absolute top-2 left-2 bg-[#3377cc] text-white uppercase px-4 py-2 text-xs font-semibold rounded-md
          shadow-lg"
          fromNow
        >
